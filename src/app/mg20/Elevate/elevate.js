      ...
      <div>
        <div className="pl-5">
          <Swiper
            ...
            slidesPerView={1.34} //한 슬라이드에 보여줄 갯수
          >
            <SwiperSlide className=" relative pr-7">
              ...
              <div className="text-gray-700 pb-2 text-xs">
            ...
            <SwiperSlide className="pr-7">
              ...
              <div className="text-gray-700 pb-2 text-xs">MW01 Wireless</div>
              <div className=" absolute text-xs border-zinc-700 border-[1px]  rounded-[0.2rem] bg-zinc-700 text-white items-center justify-center top-3 left-7 p-1">
                Sold out
              </div>
              <div className="flex justify-between font-extralight text-xs">
            ...
            <SwiperSlide className="pr-7">
              <img src="img/pagemh40-wireless/elevate/800x800_PDP_RP40NVY.png"></img>
              <div className="text-gray-700 pb-2 text-xs">
                MH40 Wireless Ear Pads
              </div>
              {/* <div className=" absolute text-xs border-zinc-700 border-[1px]  rounded-[0.2rem] bg-zinc-700 text-white items-center justify-center top-3 left-7 p-1">
                Sold out
              </div> */}
