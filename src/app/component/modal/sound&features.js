            ...
            <div className="">
              <ul className="space-y-5 pb-10">
                <li className="text-gray-600">
                  ...
                  <div className="font-light">40mm beryllium</div>
                </li>
                <li className="text-gray-600">
                ...
                <li className="text-gray-600">
                  ...
                  <div className="font-light">wind protection</div>
                </li>
                <li className="text-gray-600">
                  <div className="pb-2">ANC Microphones</div>
                  <div className="font-light">4 microphone ANC solution</div>
                </li>
                <li className="text-gray-600">
