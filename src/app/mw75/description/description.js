  ...
  return (
    <div className="p-5">
      <div className="pt-5 flex items-center text-xs text-gray-600">
        <img src="img/pagemw75/appeal/ANC.svg" />
        ANC
      </div>
      <div className=" flex items-center text-xs text-gray-600">
        <img src="img/pagemw75/appeal/headphones_icon_48cc64b5-d3e6-454d-8877-a2a3030929f7.svg" />
        Anodized aluminum, tempered glass and lambskin leather
      </div>
      <div className=" flex items-center text-xs text-gray-600">
        <img src="img/pagemw75/appeal/Driver.svg" />
        40mm beryllium drivers
      </div>
      <div className=" flex items-center text-xs text-gray-600">
        <img src="img/pagemw75/appeal/battery_icon_f66375fe-5a76-4287-bdaa-ea7291939d1f.svg" />
        32 hours of listening
      </div>
      <div className="flex items-center text-xs text-gray-600">
        <img src="img/pagemw75/appeal/Icon_Bluetooth.svg" />
        Bluetooth® 5.1
      </div>
      <div className="flex items-center text-xs text-gray-600">
        <img src="img/pagemw75/appeal/Mic.svg" />4 beamforming microphones
      </div>
